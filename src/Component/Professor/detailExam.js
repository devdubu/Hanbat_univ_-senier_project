    ...
    return(
        <>
            <div className={styles.modal+ " rounded"}>
                <div className="w-full h-10 bg-gray-300 rounded-t relative">
                    <button onClick={CloseModal} className="absolute w-8 h-6 rounded bottom-2 right-2 mt-3 bg-red-500 hover:bg-red-700">
                        <FontAwesomeIcon className="text-xl pt-0.5 text-white" icon={faXmark}/>
                    </button>
                </div>
                <div>
